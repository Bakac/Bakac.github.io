	    ...
	    <section class="body-container">
		    <section class="wrapper-horizontal">
				...
				<div class="margin-top-64">
			    	...
			    	<h2 class="margin-top-64">Stress-related disorders and relationship with self and others</h2>
			    	<p>As mentioned above, both event-based autobiographical memory and script-based autobiographical knowledge serve their own functions that buffer us from stressful events. Meanwhile, individuals with maladaptive patterns in these memories may be more susceptible to various stress-related disorders. Fragmentation in event-based autobiographical memory can make individuals vulnerable to intrusions and flashbacks of highly stressful moments, which is a hallmark of post-traumatic stress disorder and panic attacks. Meanwhile, a script of distancing oneself from the self and others after stress can lead to preoccupation with self-doubt and the unresolved event, a characteristic of depression. In more complex situations where both patterns are present, individuals may struggle persistently to stabilise themselves, leading to a negative relationship with the self that manifests as self-rejecting associations and feelings of shame. They may also alter their perception of the responsiveness of others, causing unstable intimate relationships. Some related conditions include somatization, dissociation, and personality dysfunctions. <br></p>
			    	...
			    	<h3 class="toggleBtn highlight" @click.prevent="$emit('clickPage', '#')"><i class="fa fa-chevron-right toggle-icon"></i>Diminished Perception of Responsiveness in Trauma-Related Disorders [under construction]</h3>

					<h2 class="margin-top-64">Knowing your stress response type</h2>
