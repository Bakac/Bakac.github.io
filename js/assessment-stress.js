	    ...
	    <section class="body-container">
		    <section class="wrapper-horizontal">
		    	<article>
			    	...
			    	<p>In addition to remembering certain events, our reactions to stress are also influenced by our general knowledge about ourselves. Similar to how we may have a mental script for how a job interview should go, we may also have scripts for how we should respond to stressful situations. These scripts are developed through early experiences of interacting with others who fulfill or fail to meet our needs, and their responses shape our expectations of who should take responsibility for different events and how we should manage them. Appropriate responses teach us how to face challenges in adaptive ways. However, individuals who often receive invalidating responses may develop maladaptive scripts, leading them to internalize responsibility when facing stress and decrease their tendency to affiliate with themselves and others. They may become preoccupied with self-doubt and worries about the causes and consequences of the stressful events.</p>
