					...
					<section id="project" class="dark">
						<div class="card">
							...
							<div class="wrapper-horizontal flex-box margin-top-32">
								<div class="flex-60">
									<h2>Flexible Perspective Shifting in Empathy and Self-Empathy</h2>
							...
							<div class="wrapper-horizontal flex-box margin-top-64">
								<div class="flex-40">
									...
									<p>
										Chiu, C.-D., Siu, C. Y., Ng, H. C., &amp; Baldwin, M. W. (2021). Visuospatial perspective shifting and relational self-association in dispositional shame and guilt. <em>Consciousness and Cognition</em>, <em>92</em>, Article 103140. 
										<span class="toggleBtn highlight" @click="toggleTable($event)">Abstract<i class="fa fa-chevron-right toggle-icon toggle-icon-right"></i></span>
										<div class="toggle-box toggle-section">
											<div class="left-border">
												<p>Although dispositional shame and guilt have been distinguished by perceptions of the self and behavioral responses, the underlying information processing patterns remain unclear. We hypothesized that an ability to contemplate alternatives to perceptions of the current environment, i.e., flexibility in perspective shifting, may be essential to both dispositions. Dispositional shame may additionally relate to negative relational knowledge that involves a self-representation of being rejected. One hundred and six community participants rated the two dispositions, and had their flexibility in perspective shifting and internalized self-association with rejection assessed. Regression analysis indicated that a lower cost of perspective shifting was observed with dispositional guilt and shame. Yet, unlike a direct association with perspective shifting for dispositional guilt, it was an interaction between perspective shifting and negative relational knowledge that accounted for dispositional shame. The association of dispositional shame with perspective shifting was contingent upon the tendency to pair the self with rejection.</p>
												<p><b>Keywords:</b> moral emotions, rejection, self-conscious emotions, visuospatial perspective taking</p>
											</div>
										</div>
									</p>

									<p>
										Chiu, C.-D., Ng, H. C., Kwok, W. K., &amp; Tollenaar, M. (2020). Feeling empathically toward other people and the self: The role of perspective shifting in emotion sharing and self-reassurance. <em>Clinical Psychological Science, 8,&nbsp;</em>169&ndash;183. 
										<span class="toggleBtn highlight" @click="toggleTable($event)">Abstract<i class="fa fa-chevron-right toggle-icon toggle-icon-right"></i></span>
										<div class="toggle-box toggle-section">
											<div class="left-border">
												<p>Feeling one’s own emotions empathically when negative thoughts about the self arise, a defining element of self-reassurance, promotes resilience to prolonged emotional reactivity. We propose that feeling empathically toward the self is accomplished by first stepping into the shoes of an objectified, undesired self-aspect, after which the process of perspective shifting should be completed by reengaging the self to experience the moment in the first person. We hypothesize that the resumption of the egocentric perspective in perspective shifting, a cognitive characteristic of sharing other people’s emotions, is crucial for self-reassurance as well. The relationships among flexibility in perspective shifting, self-reassurance, and emotion sharing were examined in community participants. Our results show that quickly switching back to a visuospatial egocentric perspective after adopting an opposing perspective relates to self-reassurance and emotion sharing. We conclude that both reassuring the self and empathizing with other people involve flexibility in perspective shifting.</p>
												<p><b>Keywords:</b> empathy, self-compassion, executive control, task switching, visuospatial perspective taking</p>
											</div>
										</div>
									</p>
